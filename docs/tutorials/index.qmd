...
Open the [`quarto.yml`](https://github.com/craig-shenton/quarto-nhs-theme/blob/main/docs/_quarto.yml) file in your new repository and 
change `craig-shenton/quarto-nhs-theme` to `{your-user-name}/{your-project-name}`.
...
If you want to add new pages to the docs here, please read the [`contribute.qmd`](https://craig-shenton.github.io/quarto-nhs-theme/contribute.html) page for details.
